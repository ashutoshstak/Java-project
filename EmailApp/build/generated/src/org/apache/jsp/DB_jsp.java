...
public final class DB_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_s_setDataSource_0(PageContext _jspx_page_context)
    ...
    _jspx_th_s_setDataSource_0.setUrl("jdbc:mysql://127.0.0.1");
  ...
  private boolean _jspx_meth_s_update_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_s_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            Create Database EmailApp\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_s_setDataSource_1(PageContext _jspx_page_context)
    ...
    _jspx_th_s_setDataSource_1.setDriver("org.gjt.mm.mysql.Driver");
    _jspx_th_s_setDataSource_1.setUrl("jdbc:mysql://127.0.0.1/EmailApp");
    _jspx_th_s_setDataSource_1.setUser("root");
    _jspx_th_s_setDataSource_1.setPassword("");
    _jspx_th_s_setDataSource_1.setVar("con");
  ...
  private boolean _jspx_meth_s_update_1(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_s_update_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            Create Table Members(userlogin varchar(20),upass varchar(20),email varchar(30),name varchar(30),mobile varchar(10),lastlogin date,dob date,securityquestion varchar(40),answer varchar(20),profilepic mediumblob)\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_s_update_2(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_s_update_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            Create Table Emails(mailid int primary key,frommail varchar(20),tomail varchar(100),ccmail varchar(100),bccmail varchar(100),emaildate datetime,subject varchar(100),message varchar(300),status varchar(1))\n");
          out.write("        ");
  ...
  private boolean _jspx_meth_s_update_3(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_s_update_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("            Create Table Attachments(attachid int primary key,mailid int,filename varchar(30),filetype varchar(40),filedata mediumblob)\n");
          out.write("        ");
