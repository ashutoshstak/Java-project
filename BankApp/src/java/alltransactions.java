 ...
 */
@WebServlet(urlPatterns = {"/alltransactions"})
        ...
        try{
                ...
                else
                {
                    ...
                    //------------Write Your Code Here
                     stmt=con.prepareStatement("Select * from banktrans order by tid desc");
                    rs=stmt.executeQuery();
                    out.write("<table align='center'>");
                    out.write("<tr><th>Transaction Id</th><th>Account No</th><th>Amount</th><th>Transaction Type</th><th>Details</th><th>TDate</th></tr>");
                    while(rs.next())
                    {
