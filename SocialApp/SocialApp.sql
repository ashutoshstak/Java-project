CREATE TABLE MEMBERS(	EMAIL VARCHAR(30) PRIMARY KEY,	UPASS VARCHAR(10),	NAME VARCHAR(20),	STATE VARCHAR(20),	CITY VARCHAR(20),	DOB DATE,	GENDER VARCHAR(1),	SCHOOL VARCHAR(20),	COLLEGE VARCHAR(20),	HOBBIES VARCHAR(50),	ABOUTME VARCHAR(50),LASTLOGIN DATE,PHOTO MEDIUMBLOB);
CREATE TABLE FRIENDS(RID INT PRIMARY KEY,FROMEMAIL VARCHAR(30),TOEMAIL VARCHAR(30),RDATE DATE,MESSAGE VARCHAR(30),STATUS VARCHAR(1));
CREATE TABLE MESSAGES(MID INT PRIMARY KEY,FROMEMAIL VARCHAR(30),TOEMAIL VARCHAR(30),MDATE DATE,MESSAGE VARCHAR(50),PHOTO MEDIUMBLOB);
...
delete from indianstates where city is null;